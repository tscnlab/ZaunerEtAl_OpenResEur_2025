...
gtsave(context_preds_table, "output/02_tables/table_2_context.docx")
...
gtsave(context_preds_table, "output/02_tables/table_3_wearing_position.docx")
...
gtsave(combined_pred, "output/02_tables/table_4_context_position.docx")
...
ggsave(glue("output/04_unused/significance_matrix_{parameter}.jpeg"), 
       P2, width = 4, height = 4.7)
